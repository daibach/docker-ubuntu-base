...
gen() {
  ...
  echo 'RUN wget -q -0 /tmp/hugo.deb https://github.com/gohugoio/hugo/releases/download/v0.121.2/hugo_extended_0.121.2_linux-amd64.deb && dpkg -i /tmp/hugo.deb && rm /tmp/hugo.deb' >> ${NAME}/Dockerfile
  echo '' >> ${NAME}/Dockerfile
